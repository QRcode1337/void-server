        ...
        return (
            <div className="p-6 max-w-2xl mx-auto">
                ...
                <div className="card space-y-4">
                    <p className="text-[var(--color-text-secondary)]">
                        This plugin was installed after the client was built. The server has loaded
                        the plugin, but the browser needs an updated client bundle to display its interface.
                    </p>
