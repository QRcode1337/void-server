...
function MobileHeader({ sidebarOpen, toggleSidebar }) {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-30 md:hidden flex items-center justify-between px-4 h-14 bg-[var(--color-surface-solid)] border-b border-[var(--color-border)]">
      {/* Menu toggle button */}
      <button
            ...
            <div className="flex items-start gap-3 mb-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-secondary">
                  This will restart the server and reload the page. It will take approximately 10
                  seconds.
                </p>
              </div>
            </div>
